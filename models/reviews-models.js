...
exports.fetchAllReviews = () => {
    return connection.query(`SELECT reviews.review_id, title, category, review_img_url, reviews.created_at, reviews.votes, designer, owner,   COUNT(comment_id) AS comment_count FROM reviews
